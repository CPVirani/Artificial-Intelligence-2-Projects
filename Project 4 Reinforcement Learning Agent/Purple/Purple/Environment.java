...
class Environment {
	...
	public boolean climbPit() {

		if (wumpusWorld[agent.getLocation()[0]][agent.getLocation()[1]][0] == 'P') {
			wumpusWorld[agent.getLocation()[0]][agent.getLocation()[1]][0] = ' ';
			return true;
		}
		return false;
	...
	public boolean checkDeathforTrain() {

		if (wumpusWorld[agent.getLocation()[0]][agent.getLocation()[1]][1] == 'W') return true;
	...
	public boolean getPit() {
		...
		if (wumpusWorld[x][y][0] == 'P') return true;
