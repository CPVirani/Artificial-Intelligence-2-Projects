	...
	public static void main (String args[]) {
	    ...
	    try {
		    ...
		    for (int currTrial = 0; currTrial < numTrials; currTrial++) {
		    	Environment training = new Environment(worldSize, wumpusWorld, outputWriter);
				AgentTraining agentTraining = new AgentTraining(training);
//				training.printEnvironment();

				for (int i = 0; i < qTableConfig.ITERATIONS; i++){
//					System.out.println("--------------------Iteration: " + String.valueOf(i) + "----------------------");
					agentTraining.train();
//					training.printEnvironment();
				}
//				qTable.DisplayqTable();
