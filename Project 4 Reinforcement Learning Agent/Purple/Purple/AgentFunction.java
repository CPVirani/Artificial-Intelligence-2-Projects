...
class AgentFunction {
	...
	private String agentName = "Agent Purple";
	...
	public int process(TransferPercept tp,int[] location)
	{
	    ...
	    return qTable.getBestActionMaxQValueAction(location[0],location[1]) ;
	}
